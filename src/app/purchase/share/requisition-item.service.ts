...
export class RequisitionItemService {
  ...
  apiName: string = 'requisitionitem';
  ...
  allByRequisitionID(requisition_id: string) {
    return new Promise((resolve, reject) => {
      this.authHttp.get(`${this.url}/${this.apiName}/allbyrequisitionid/${requisition_id}`)
        .map(res => res.json())
        .subscribe(data => {
          resolve(data);
        }, error => {
  ...
  allByRequisitionIDNoRelation(requisition_id: string) {
    return new Promise((resolve, reject) => {
      this.authHttp.get(`${this.url}/${this.apiName}/allbyrequisitionid-norelation/${requisition_id}`)
        .map(res => res.json())
        .subscribe(data => {
          resolve(data);
        }, error => {
